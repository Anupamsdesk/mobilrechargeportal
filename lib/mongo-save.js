...
var Collection = function (name){	
	...
	this.Add = function(){
		...
		this.mongocli.open(function (err, client){
...
var getConnection = function (hostname,port,dbname, callback){
	
	var x = MongoClient.connect(connectString, function(err,db){
		if (err) throw err;
		else
			callback(db);
	});		
...
var createCollection = function (connection, collectionName, callback){
	connection.create(collectionName, function(err,data){
		if (err) throw err;
		console.dir(data);
